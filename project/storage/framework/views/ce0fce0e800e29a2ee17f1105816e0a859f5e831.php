...
<?php if($isDev): ?>
    <li>
        ...
        <ul class="collapse list-unstyled" id="emails" data-parent="#accordion">
            ...
            <li><a href="<?php echo e(route('admin-mail-config')); ?>"><span><?php echo e(__('Email Configurations')); ?></span></a>
            </li>
...
<?php if($isDev): ?>
    <li>
        ...
        <ul class="collapse list-unstyled" id="langs" data-parent="#accordion">
            ...
            <li><a href="<?php echo e(route('admin-tlang-index')); ?>"><span><?php echo e(__('Admin Panel Language')); ?></span></a>
            </li>
...
<?php endif; ?>
<?php /**PATH E:\RF\laragon\www\bossdrinks\project\resources\views/includes/admin/roles/super.blade.php ENDPATH**/ ?>