...
<?php echo $__env->make('frontend.layouts.partials.carousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="container product_variety">
  ...
  <div>
    <a href="energydrinks.html"><?php echo e($category->name); ?></a>
  </div>
...
<div class="MainProductDisplaySection">
  ...
  <div class="productdisplaysection">
    ...
    <div class="card card2">
      <div class="productdisplayimgBOX">
        <a href="<?php echo e(route('front.product', $product->slug)); ?>">
          <img src="/img/PDSEnergy Boss Original Blue.png" alt="comething">
        </a>
      </div>
      <div class="product_display_contentbox">
        <h4><?php echo e($product->name); ?></h4>
        <h4 class="price">&#128 <?php echo e($product->price); ?></h4>
        <a href="<?php echo e(route('front.product', $product->slug)); ?>" class="buy">Veiw Details</a>
      </div>
  ...
  <div class="productdisplaysection productdisplaysection2">
    <?php $__currentLoopData = $products2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card card2">
      <div class="productdisplayimgBOX">
        <a href="<?php echo e(route('front.product', $product->slug)); ?>">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.newsletter','data' => []]); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\RF\laragon\www\bossdrinks\project\resources\views/frontend/pages/home.blade.php ENDPATH**/ ?>