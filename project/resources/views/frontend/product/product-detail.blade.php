...
<div class="productdetails row productdeitails_web">
  <div class="imgshowclass col-12 col-lg-6 imgshowclass_single">
    <div>
      <img src="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:asset('assets/images/products/'.$productt->photo)}}" alt="something" style="filter: drop-shadow(3px 4px 6px black);">
    </div>
          ...
          <div id="collapsetwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;" data-parent="#accordion">
            <div class="panel-body">
              <ul class="nutritional_INFO ">
                ...
                <li class="row"><span class="left col-7">Niacin: </span><span class="right col-5">16mg (100%*)</span>
                </li>
              ...
              <!-- {{html_entity_decode($productt->policy)}} -->
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="radioDIVsingle1">
        ...
        <div class="addtocart-btn">
          ...
          <button class="button-30" id="button-30_2" role="button">
            <h4 class="button-30_price_2">&#163; {{$productt->price}}</h4><i class="fa fa-shopping-cart"></i> Add
            To
            cart
          </button>
        </div>
...
<div class="newsletter_sb">
  <form action="">
    ...
    <div class="email-box_newsletter">
      ...
      <input class="newsletter_email" type="email" name="" placeholder="Enter Your Email" onchange="diplay_wide(event)">
...
<div class="modal-bg">
  ...
  <div class="modal_tnc">
    ...
    <div class="first_tnc">
      ...
      <p id="agreement_text">If you purchase goods from our site, our <a id="email_text" href="#terms_delivery">Terms and
      ...
      <p id="agreement_text"><span id="span_1">How long do I have to change my mind?
        ...
        You have 14 days after the day you (or someone you nominate) receives the goods, <span id="span_1">unless your
          goods
          are split into
      ...
      <p id="agreement_text"><span id="span_1">Tell us you want to end the contract.
        ...
        Phone or email. Call customer services on +44 20 000 00 or email us at <a id="email_text">info@bossdrinks.com</a>.
        Please
        provide your name,
      ...
      <p id="agreement_text"><span id="span_1">Returning products after ending the contract.
        ...
        us to collect them
        from you. Please call customer services on +44 20 000 00 or email us at <a id="email_text">info@bossdrinks.com</a> for a return label or to
    ...
    <div class="second_tnc">
      ...
      <div class="P_SPAN_Div">
        ...
        <div class="p_and_span">
          <p>Italy, Lithuania, Slovakia, Spain, Sweden (5-7 working days) –</p><span id="dark_text">Temporarily
            Unavailable</span>
        </div>
        <div class="p_and_span">
          <p>Bulgaria, Croatia, Estonia, Finland, Greece, Romania (5-7 working days) –</p><span id="dark_text">Temporarily Unavailable</span>
        </div>
        <div class="p_and_span">
        ...
        <div class="p_and_span">
          <p>Ireland, Austria, Denmark, France, Hungary, Slovenia (4-5 working days) –</p><span id="dark_text">Temporarily Unavailable</span>
        </div>
