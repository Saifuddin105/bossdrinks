...
<nav id="navbar" class="py-3 px-5">
    ...
    <div class="secondtopbar row">
        ...
        <div class=" third-part col-lg-4 sm-4 col-3  text-center">
            ...
            <a href="{{ route('front.showCart') }}"> <button id="cart-btn" class="navbar-btn " type="button">
                    ...
                    <div class="quantity-back" id="quantity-back"> <span id="cart-quantity"></span></div>
                </button></a>
            @if (Auth::user())
    ...
    <div class="login_modal_bg">
        <div class="login_modal">
            ...
            <p id="P_TAG">We are a subscription-first business. For you to change or skip a delivery in the future, you
                will
            ...
            <div class="All_button_class">
                ...
                <a class="google_btn_class" href="{{ route('social-provider', ['provider' => 'google']) }}"
                    id="google_btn">
                    <img id="login_img" src="/img/google_logo.png" alt="">
                    <p>Continue with Google</p>
                </a>
                <a class="facebook_btn_class" href="{{ route('social-provider', ['provider' => 'facebook']) }}"
                    id="facebook_btn">
            ...
            <form class="bs_login" action="{{ route('user.login.submit') }}" method="POST">
                ...
                <div class="LOGIN_FORM">
                    ...
                    <div class="pass">
                        <input id="login_modal_pass" style="border:none" name="password" type="password"
                            placeholder="Password">
                        <img class="eye_icon_1" src="img/eye.png" alt="" id="eye_icon" onclick="togglePW()"
                            style="height:20px">
            ...
            <form class="bs_signup" action="{{ route('user-register-submit') }}" method="POST">
                ...
                <div class="SIGNUP_FORM">
                    ...
                    <img src="img/eye.png" class="eye_icon_2" alt="" id="eye_icon" onclick="togglePW1()"
                        style="height:20px">
                    <input id="signup_pass_confirm" name="password_confirmation" type="password"
                        placeholder="Confirm Password" required="required" style="margin-top: -12px;">
                    <img src="img/eye.png" class="eye_icon_3" alt="" id="eye_icon" onclick="togglePW()"
                        style="height:20px">
...
<script>
    ...
    let cartTotalQuantity = document.getElementById("cart-quantity")
    if (cartData?.productDetails.length > 0) {
        let productQuantity = 0
        for (let i = 0; i < cartData.productDetails.length; i++) {
            productQuantity += cartData.productDetails[i].quantity
        }
        cartTotalQuantity.innerText = productQuantity
    }
