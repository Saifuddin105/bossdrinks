...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/front/resources/css/style.css')}}">
</head>
...
<body style="background: #F4F1E8;">
   ...
   ?>
    ...
    <div class="main">
        <nav id="navbar" class="py-3 px-5" style="background: #F4F1E8;">
        ...
        <div class="finalFooter" style="background: #F4F1E8;">
        ...
        <!-- final Footer ends *************************************************************************************-->
        <div class="Footer_for_mobile" style="background: #F4F1E8;">
