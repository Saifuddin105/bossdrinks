                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="table-responsive show-table">
                                                        ...
                                                        @if(isset($persionalInfo->gender))
                                                        <tr>
                                                            <th>{{ __("Gender") }}</th>
                                                            <td>{{ $persionalInfo->gender }}</td>
                                                        </tr>
                                                        @endif
                                                        @if(isset($persionalInfo->date_of_birth))
                                                        <tr>
                                                            <th>{{ __("Date Of Birth") }}</th>
                                                            <td>{{ $persionalInfo->date_of_birth }}</td>
                                                        </tr>
                                                        @endif
                                                     ...
                                                     @endif
                                                        ...
                                                        @endif
                                                        @if(isset($persionalInfo->street))
                                                        <tr>
                                                            <th>{{ __("Street") }}</th>
                                                            <td>{{ $persionalInfo->street }}</td>
                                                        </tr>
                                                        @endif
                                                        @if(isset($persionalInfo->city))
                                                        <tr>
                                                            <th>{{ __("City") }}</th>
                                                            <td>{{ $persionalInfo->city }}</td>
                                                        </tr>
                                                        @endif
                                                        @if(isset($persionalInfo->buld_name))
                                                        <tr>

                                                            <th>{{ __("Buliding Name") }}</th>
                                                            <td>{{ $persionalInfo->buld_name }}</td>
                                                        </tr>
                                                        @endif
                                                        ...
                                                        <tr>
                                                            <th>{{ __("Post Code") }}</th>
                                                            <td>{{ $persionalInfo->post_code }}</td>
                                                        </tr>
                                                        @endif
                                                        @if(isset($persionalInfo->located_year))
                                                        <tr>
                                                            <th>{{ __("Located Year") }}</th>
                                                            <td>{{ $persionalInfo->located_year }}</td>
                                                        </tr>
                                                        @endif
