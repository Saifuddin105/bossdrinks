                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang770" placeholder="Wholesell" required="" value="{{ $lang->lang770 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang768" placeholder="Quantity" required="" value="{{ $lang->lang768 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang769" placeholder="Discount" required="" value="{{ $lang->lang769 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang771" placeholder="Off" required="" value="{{ $lang->lang771 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang776" placeholder="Report This Item" required="" value="{{ $lang->lang776 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang777" placeholder="REPORT PRODUCT" required="" value="{{ $lang->lang777 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang779" placeholder="Enter Report Title" required="" value="{{ $lang->lang779 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang780" placeholder="Enter Report Note" required="" value="{{ $lang->lang780 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="razorpay" placeholder="Razorpay" required="" value="{{ $lang->razorpay }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang781" placeholder="Card number not valid" required="" value="{{ $lang->lang781 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang782" placeholder="CVC number not valid" required="" value="{{ $lang->lang782 }}">
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang808" placeholder="Recent Orders" required="" value="{{ isset($lang->lang808) ? $lang->lang808 : 'Recent Orders' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang809" placeholder="Total Orders" required="" value="{{ isset($lang->lang809) ? $lang->lang809 : 'Total Orders' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang810" placeholder="Pending Orders" required="" value="{{ isset($lang->lang810) ? $lang->lang810 : 'Pending Orders' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang811" placeholder="All Time" required="" value="{{ isset($lang->lang811) ? $lang->lang811 : 'All Time' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang812" placeholder="My Balance" required="" value="{{ isset($lang->lang812) ? $lang->lang812 : 'My Balance' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang772" placeholder="Order Tracking" required="" value="{{ $lang->lang772 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang773" placeholder="Get Tracking Code" required="" value="{{ $lang->lang773 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang774" placeholder="View Tracking" required="" value="{{ $lang->lang774 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang775" placeholder="No Order Found." required="" value="{{ $lang->lang775 }}">
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang786" placeholder="Vendor Verification" required="" value="{{ $lang->lang786 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang787" placeholder="Details" required="" value="{{ $lang->lang787 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang788" placeholder="Enter Verification Details" required="" value="{{ $lang->lang788 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang789" placeholder="Attachment" required="" value="{{ $lang->lang789 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang792" placeholder="(Maximum Size is: 10MB)" required="" value="{{ $lang->lang792 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang790" placeholder="Add More Attachment" required="" value="{{ $lang->lang790 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang791" placeholder="Submit" required="" value="{{ $lang->lang791 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang795" placeholder="Payment Method" required="" value="{{ $lang->lang795 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang796" placeholder="Charge ID" required="" value="{{ $lang->lang796 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang797" placeholder="Transaction ID" required="" value="{{ $lang->lang797 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang798" placeholder="Payment Status" required="" value="{{ $lang->lang798 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang799" placeholder="Unpaid" required="" value="{{ $lang->lang799 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang800" placeholder="Paid" required="" value="{{ $lang->lang800 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang801" placeholder="Order Note" required="" value="{{ $lang->lang801 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang793" placeholder="Product Sku" required="" value="{{ $lang->lang793 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang794" placeholder="Enter Product Sku" required="" value="{{ $lang->lang794 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang629" placeholder=" Product" required="" value="{{ $lang->lang629 }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang805" placeholder="Prefered Size: (800x800) or Square Size." required="" value="{{ isset($lang->lang805) ? $lang->lang805 : 'Prefered Size: (800x800) or Square Size.' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang806" placeholder="Image height and width must be 600 x 600." required="" value="{{ isset($lang->lang806) ? $lang->lang806 : 'Image height and width must be 600 x 600.' }}">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang807" placeholder="Image must have square size." required="" value="{{ isset($lang->lang807) ? $lang->lang807 : 'Image must have square size' }}">
                        </div>
                      </div>
